        ...
        <div className="w-full max-w-md bg-white rounded-lg shadow-md p-6">
          ...
          <div className="space-y-2">
            ...
            <button
              ...
              className="w-full py-2.5 border border-[#fae300] bg-[#fae300] text-black text-sm font-semibold rounded-md flex items-center justify-center hover:bg-[#e8d800] transition duration-150"
            >
              <svg
                width="16px"
                height="16px"
